        ...
        const renderTableSection = () => {
            return (
                <>
                    ...
                    <Table>
                        <TableHead>
                            <StyledTableRow>
                                ...
                                <StyledTableCell>Presença</StyledTableCell>
                                <StyledTableCell>Total de Presenças</StyledTableCell>
                    ...
                    <div>
                        Porcentagem geral de presença: {overallAttendancePercentage.toFixed(2)}%
                    </div>
                    <Button variant="contained" color="error" startIcon={<DeleteIcon />} onClick={() => removeHandler(studentID, "RemoveStudentAtten")}>Exlcuir todas</Button>
    ...
    const StudentDetailsSection = () => {
        return (
            <div>
                ...
                <br />
                Matricula: {userDetails.rollNum}
                <br />
                Turma: {sclassName.sclassName}
                <br />
                        ...
                        <TabContext value={value}>
                            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                                <TabList onChange={handleChange} sx={{ position: 'fixed', width: '100%', bgcolor: 'background.paper', zIndex: 1 }}>
                                    ...
                                    <Tab label="Presenças" value="2" />
                                    <Tab label="Marcar" value="3" />
                                </TabList>
                            </Box>

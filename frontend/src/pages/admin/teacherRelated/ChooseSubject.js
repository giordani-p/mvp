...
const ChooseSubject = ({ situation }) => {
    ...
    if (loading) {
        ...
        return <div>
            <h1>Desculpe, todas as disciplinas já têm professores atribuídos</h1>
                    ...
                    <Table aria-label="sclasses table">
                        <TableHead>
                            <StyledTableRow>
                                ...
                                <StyledTableCell align="center">Nome da aula</StyledTableCell>
                                <StyledTableCell align="center">Código da aula</StyledTableCell>

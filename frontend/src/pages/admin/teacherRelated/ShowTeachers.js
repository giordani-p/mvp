...
const ShowTeachers = () => {
    ...
    const columns = [
        ...
        { id: 'teachSubject', label: 'Matéria', minWidth: 100 },
        { id: 'teachSclass', label: 'Turma', minWidth: 170 },
    ];
    ...
    const actions = [
        {
            icon: <PersonAddAlt1Icon color="primary" />, name: 'Add Novo Professor',
            action: () => navigate("/Admin/teachers/chooseclass")
        },
        {
            icon: <PersonRemoveIcon color="error" />, name: 'Excluir todos professores',

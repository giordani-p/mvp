        ...
        <>
            {loading
                ...
                <div>
                    ...
                    <br />
                    Número de matricula: {userDetails.rollNum}
                    <br />
                    Turma: {sclassName.sclassName}
                    <br />
                    Escola: {studentSchool.schoolName}
                    <br /><br />
                    ...
                    {subjectAttendance && Array.isArray(subjectAttendance) && subjectAttendance.length > 0
                        ...
                        <>
                                        ...
                                        <Table key={index}>
                                            <TableHead>
                                                <StyledTableRow>
                                                    ...
                                                    <StyledTableCell>Total de Presença</StyledTableCell>
                                                    <StyledTableCell>% Presença</StyledTableCell>
                            ...
                            <div>
                                Porcentagem geral de frequência: {overallAttendancePercentage.toFixed(2)}%
                            </div>
